...
class Chemical_assets:
    ...
    def get_capacity_events(
        self, ProductionUnitCode: Optional[Union[list[str], Series[str], str]] = None, ProductName: Optional[Union[list[str], Series[str], str]] = None, ProductionRoute: Optional[Union[list[str], Series[str], str]] = None, PlantCode: Optional[Union[list[str], Series[str], str]] = None, PlantName: Optional[Union[list[str], Series[str], str]] = None, UnitName: Optional[Union[list[str], Series[str], str]] = None, City: Optional[Union[list[str], Series[str], str]] = None, State: Optional[Union[list[str], Series[str], str]] = None, Country: Optional[Union[list[str], Series[str], str]] = None, Region: Optional[Union[list[str], Series[str], str]] = None, EventBeginDate: Optional[Union[list[date], Series[date], date]] = None, EventType: Optional[Union[list[str], Series[str], str]] = None, Value: Optional[Union[list[str], Series[str], str]] = None, UoM: Optional[Union[list[str], Series[str], str]] = None, CurrentOwnerName: Optional[Union[list[str], Series[str], str]] = None, validfrom: Optional[Union[list[date], Series[date], date]] = None, validto: Optional[Union[list[date], Series[date], date]] = None, reason: Optional[Union[list[str], Series[str], str]] = None, isactive: Optional[Union[list[str], Series[str], str]] = None, filter_exp: Optional[str] = None, page: int = 1, page_size: int = 1000, raw: bool = False, paginate: bool = False
        ...
        ----------
         ...
         ProductName: Optional[Union[list[str], Series[str], str]]
         ...
         CurrentOwnerName: Optional[Union[list[str], Series[str], str]]
        ...
        filter_params.append(list_to_filter("ProductName", ProductName))
        ...
        filter_params.append(list_to_filter("CurrentOwnerName", CurrentOwnerName))
    ...
    def get_average_annual_capacities(
        self, ProductionUnitCode: Optional[Union[list[str], Series[str], str]] = None, ProductName: Optional[Union[list[str], Series[str], str]] = None, ProductionRoute: Optional[Union[list[str], Series[str], str]] = None, PlantCode: Optional[Union[list[str], Series[str], str]] = None, PlantName: Optional[Union[list[str], Series[str], str]] = None, UnitName: Optional[Union[list[str], Series[str], str]] = None, City: Optional[Union[list[str], Series[str], str]] = None, State: Optional[Union[list[str], Series[str], str]] = None, Country: Optional[Union[list[str], Series[str], str]] = None, Region: Optional[Union[list[str], Series[str], str]] = None, year: Optional[Union[list[str], Series[str], str]] = None, Average_Annual_Capacity: Optional[Union[list[str], Series[str], str]] = None, UoM: Optional[Union[list[str], Series[str], str]] = None, CurrentOwnerName: Optional[Union[list[str], Series[str], str]] = None, validfrom: Optional[Union[list[date], Series[date], date]] = None, validto: Optional[Union[list[date], Series[date], date]] = None, reason: Optional[Union[list[str], Series[str], str]] = None, isactive: Optional[Union[list[str], Series[str], str]] = None, filter_exp: Optional[str] = None, page: int = 1, page_size: int = 1000, raw: bool = False, paginate: bool = False
    ) -> Union[DataFrame, Response]:
        """
        Fetch the data based on the filter expression.
