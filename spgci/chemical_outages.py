...
class Chemical_outages:
    ...
    def get_data(
        self, unit_name: Optional[Union[list[str], Series[str], str]] = None, unit_code: Optional[Union[list[str], Series[str], str]] = None, alert_name: Optional[Union[list[str], Series[str], str]] = None, outage_id: Optional[Union[list[str], Series[str], str]] = None, plant_code: Optional[Union[list[str], Series[str], str]] = None, product: Optional[Union[list[str], Series[str], str]] = None, country: Optional[Union[list[str], Series[str], str]] = None, region: Optional[Union[list[str], Series[str], str]] = None, owner: Optional[Union[list[str], Series[str], str]] = None, outage_type: Optional[Union[list[str], Series[str], str]] = None, uom: Optional[Union[list[str], Series[str], str]] = None, capacity: Optional[Union[list[str], Series[str], str]] = None, capacity_down: Optional[Union[list[str], Series[str], str]] = None, runrate: Optional[Union[list[str], Series[str], str]] = None, modified_date: Optional[Union[list[str], Series[str], str]] = None, start_date: Optional[Union[list[str], Series[str], str]] = None, end_date: Optional[Union[list[str], Series[str], str]] = None, filter_exp: Optional[str] = None, page: int = 1, page_size: int = 1000, raw: bool = False, paginate: bool = False
        ...
        ----------
         ...
         unit_code: Optional[Union[list[str], Series[str], str]]
        ...
        filter_params.append(list_to_filter("unit_code", unit_code))
