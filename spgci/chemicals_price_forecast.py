...
class Chemicals_price_forecast:
    ...
    def get_long_term_prices(
        self, scenario_id: Optional[Union[list[str], Series[str], str]] = None, scenario_description: Optional[Union[list[str], Series[str], str]] = None, series_description: Optional[Union[list[str], Series[str], str]] = None, commodity: Optional[Union[list[str], Series[str], str]] = None, commodity_grade: Optional[Union[list[str], Series[str], str]] = None, associated_platts_symbol: Optional[Union[list[str], Series[str], str]] = None, delivery_region: Optional[Union[list[str], Series[str], str]] = None, shipping_terms: Optional[Union[list[str], Series[str], str]] = None, currency: Optional[Union[list[str], Series[str], str]] = None, contract_type: Optional[Union[list[str], Series[str], str]] = None, series_type: Optional[Union[list[str], Series[str], str]] = None, value_type: Optional[Union[list[str], Series[str], str]] = None, value: Optional[Union[list[str], Series[str], str]] = None, unit_of_measure: Optional[Union[list[str], Series[str], str]] = None, publish_date: Optional[Union[list[str], Series[str], str]] = None, year: Optional[Union[list[str], Series[str], str]] = None, valid_to: Optional[Union[list[date], Series[date], date]] = None, valid_from: Optional[Union[list[date], Series[date], date]] = None, is_active: Optional[Union[list[str], Series[str], str]] = None, filter_exp: Optional[str] = None, page: int = 1, page_size: int = 1000, raw: bool = False, paginate: bool = False
        ...
        filter_params.append(list_to_filter("series_type", series_type))
        filter_params.append(list_to_filter("value_type", value_type))
    ...
    def get_short_term_prices(
        self, scenario_id: Optional[Union[list[str], Series[str], str]] = None, scenario_description: Optional[Union[list[str], Series[str], str]] = None, series_description: Optional[Union[list[str], Series[str], str]] = None, commodity: Optional[Union[list[str], Series[str], str]] = None, commodity_grade: Optional[Union[list[str], Series[str], str]] = None, associated_platts_symbol: Optional[Union[list[str], Series[str], str]] = None, delivery_region: Optional[Union[list[str], Series[str], str]] = None, shipping_terms: Optional[Union[list[str], Series[str], str]] = None, currency: Optional[Union[list[str], Series[str], str]] = None, contract_type: Optional[Union[list[str], Series[str], str]] = None, series_type: Optional[Union[list[str], Series[str], str]] = None, value_type: Optional[Union[list[str], Series[str], str]] = None, value: Optional[Union[list[str], Series[str], str]] = None, unit_of_measure: Optional[Union[list[str], Series[str], str]] = None, publish_date: Optional[Union[list[str], Series[str], str]] = None, date: Optional[Union[list[date], Series[date], date]] = None, valid_to: Optional[Union[list[date], Series[date], date]] = None, valid_from: Optional[Union[list[date], Series[date], date]] = None, is_active: Optional[Union[list[str], Series[str], str]] = None, filter_exp: Optional[str] = None, page: int = 1, page_size: int = 1000, raw: bool = False, paginate: bool = False
    ) -> Union[DataFrame, Response]:
        """
        Fetch the data based on the filter expression.
